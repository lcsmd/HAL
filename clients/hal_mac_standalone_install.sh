#!/bin/bash
# HAL Voice Client - Standalone Mac Installer
# No server required - contains everything embedded
# Usage: bash hal_mac_standalone_install.sh

set -e

# Configuration - EDIT THIS LINE if needed
HAL_SERVER_URL="http://10.1.34.103:8768"

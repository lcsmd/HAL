...
# Compile TEST.DICT
Write-Host "`nCompiling TEST.DICT..."
$writer.WriteLine("BASIC BP TEST.DICT")
...
# Catalog TEST.DICT
Write-Host "`nCataloging TEST.DICT..."
$writer.WriteLine("CATALOG BP TEST.DICT")
Start-Sleep -Milliseconds 2000
while ($stream.DataAvailable) {
    $line = $reader.ReadLine()
    Write-Host $line
...
# Run TEST.DICT
Write-Host "`nRunning TEST.DICT..."
$writer.WriteLine("TEST.DICT")
